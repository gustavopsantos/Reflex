...
namespace Reflex.Exceptions
{
    ...
    {
        public ConstructorInjectorException(Type type, Exception exception, MethodParamInfo[] constructorParameters) : base(BuildMessage(type, exception, constructorParameters))
        {
        }

        private static string BuildMessage(Type type, Exception exception, MethodParamInfo[] constructorParameters)
        {
