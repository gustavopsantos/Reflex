...
//namespace Reflex.Microsoft.Editor.DebuggingWindow
//{
//    public class ReflexDebuggerWindow : EditorWindow
//    {
//        private const string _containerIcon = "winbtn_win_max_h"; // d_PrefabModel On Icon, "PreMatCylinder"
//        private const string _resolverIcon = "d_NetworkAnimator Icon"; // "d_eyeDropper.Large", "AnimatorStateTransition Icon", "RelativeJoint2D Icon"
...
//		private static List<(Resolver, Type[])> BuildMatrix(IServiceProvider serviceProvider)
//        {
//            var resolvers = serviceProvider.ResolversByContract.Values.SelectMany(r => r).Distinct();
//            return resolvers.Select(resolver => (resolver, GetContracts(resolver, serviceProvider))).ToList();
//        }
        
//        private static Type[] GetContracts(Resolver resolver, IServiceProvider serviceProvider)
//        {
//            var result = new List<Type>();

//            foreach (var pair in serviceProvider.ResolversByContract)
//            {
...
//        private void BuildDataRecursively(MyTreeElement parent, IServiceProvider serviceProvider)
//        {
...
//            var child = new MyTreeElement(serviceProvider.Name, parent.Depth + 1, ++_id, _containerIcon, () => string.Empty, Array.Empty<string>(), string.Empty);
//            parent.Children.Add(child);
//            child.Parent = parent;
            
//            foreach (var pair in BuildMatrix(serviceProvider))
//            {
...
//            foreach (var scopedContainer in serviceProvider.Children)
//            {
...
//        {
//            var root = new MyTreeElement("Root", -1, ++_id, _containerIcon, () => string.Empty, Array.Empty<string>(), string.Empty);
//            BuildDataRecursively(root, Tree<IServiceProvider>.Root);
